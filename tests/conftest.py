...
# WARNING: Ensure imports from `fastapi_template` comes after this line
from fastapi_template import app, settings, db  # noqa
from fastapi_template.cli import create_user, cli  # noqa
