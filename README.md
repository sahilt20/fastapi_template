...
[![codecov](https://codecov.io/gh/sahilt20/fastapi_template/branch/main/graph/badge.svg?token=fastapi_template_token_here)](https://codecov.io/gh/sahilt20/fastapi_template)
[![CI](https://github.com/sahilt20/fastapi_template/actions/workflows/main.yml/badge.svg)](https://github.com/sahilt20/fastapi_template/actions/workflows/main.yml)

Awesome fastapi_template created by sahilt20

## Install

from source
```bash
git clone https://github.com/sahilt20/fastapi_template fastapi_template
cd fastapi_template
make install
```
